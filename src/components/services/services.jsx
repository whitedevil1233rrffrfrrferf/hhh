    ...
    return(
        ...
        <section id="service">
            ...
            <div className="container portfolio_container">
               <ArticleComponent title="Todo list" img={img2} gitLink="https://github.com/whitedevil1233rrffrfrrferf/to-do-list" demoLink="https://todolistsit.netlify.app" />
               ...
               <ArticleComponent title="Note_pad" img={img3} gitLink="https://github.com/whitedevil1233rrffrfrrferf/keeper_app" demoLink="https://keeper-app-main.netlify.app" />
